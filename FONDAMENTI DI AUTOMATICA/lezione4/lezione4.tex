...
\textbf{link} \href{https://onedrive.live.com/?authkey=%21AATVJK3srNwxGzs&id=EE092FF4FF7B5B0E%212158&cid=EE092FF4FF7B5B0E}{Link a uan registrazione di back up}
\subsection*{Manca registrazione della lezione}
[RICOPIO APPUNTI PRESI DALLE SOLE SLIDE DEL PROF]
...
\newline
S', vi sono criteri per dirlo basati sull'ispezione di $A$ o del suo polinomio caratteristico (PC) $\Pi(s) = det (sI-A)$:
\begin{itemize}
    ...
    \item Se $Re(S_i)<0$ per ogni $i$ (cioè se il sistema è AS), allora i coefficienti di $\Pi(S)$ sono tutti concordi e non nulli.
    \item \dots
\end{itemize}