...
\begin{align*}
\text{Rapporto compressione volumetrico:} &\qquad r = \frac{V_1}{V_2} = \frac{V_{max}}{V_{min}} \\
\text{Rapporto di combustione:} &\qquad z = \frac{V_3}{V_2} = \frac{V_{\text{fine combustione}}}{V_{\text{inizio combustione}}} \\
\end{align*}

\[ \eta_{diesel} = 1 - \frac{1}{r^{k-1}} \frac{1}{k} \frac{z^k-1}{z-1} \]

\subsubsection{Confronto ciclo Otto - ciclo Diesel}
\begin{itemize}
