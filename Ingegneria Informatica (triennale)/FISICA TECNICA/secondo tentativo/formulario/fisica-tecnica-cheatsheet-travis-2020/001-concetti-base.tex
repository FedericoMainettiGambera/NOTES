...
$\beta$ e $K_T$ possono essere considerati costanti per ampi intervalli di temperatura e di pressione. La precedente relazione differenziale è quindi integrabile e lo stato calcolabile. Un modello semplificato consiste nel considerare liquidi e solidi incomprimibili ($v =$ costante).